...
import { MainContainer, CardContainer, BlogCard, TopContainer, BottomContainer, Author, Date } from './BlogSection.styled'
        ...
        <BlogCard key={index}>
            ...
            <BottomContainer>
                <Author>
                    ...
                    <Avatar url={blog.author.image} size='xs' borderColor={theme?.colors.brandBlue} borderWidth={2} />
                    <Typography variant="bodySmall">{blog.author.name}</Typography>
                </Author>
                <Date><Typography variant='bodySmall'>
                    {blog.date}
                </Typography></Date>
            </BottomContainer>
        </BlogCard>
